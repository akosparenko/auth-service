import { EntityIdNotSetException } from "@auth/domain/exceptions/entity-id-not-set.exception.js";
import { EntityId } from "@auth/domain/value-objects/entity-id.vo.js";
